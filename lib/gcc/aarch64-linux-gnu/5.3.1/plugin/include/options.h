...
enum opt_code
{
  ...
  OPT_flive_range_shrinkage = 763,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 764,                    /* -flocal-ivars */
  ...
  OPT_floop_unroll_and_jam = 772,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 773,                      /* -flra-remat */
  OPT_flto = 774,                            /* -flto */
  OPT_flto_compression_level_ = 775,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 776,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 777,                 /* -flto-partition= */
  ...
  OPT_foffload_abi_ = 821,                   /* -foffload-abi= */
  OPT_foffload_ = 822,                       /* -foffload= */
  OPT_fomit_frame_pointer = 823,             /* -fomit-frame-pointer */
  OPT_fopenacc = 824,                        /* -fopenacc */
  OPT_fopenmp = 825,                         /* -fopenmp */
  OPT_fopenmp_simd = 826,                    /* -fopenmp-simd */
  OPT_foperator_names = 827,                 /* -foperator-names */
  OPT_fopt_info = 828,                       /* -fopt-info */
  OPT_fopt_info_ = 829,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 830, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 831,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 832,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 833,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 834, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 835,              /* -foutput-class-dir= */
  OPT_fpack_derived = 836,                   /* -fpack-derived */
  OPT_fpack_struct = 837,                    /* -fpack-struct */
  OPT_fpack_struct_ = 838,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 839,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 840,              /* -fpcc-struct-return */
  OPT_fpch_deps = 841,                       /* -fpch-deps */
  OPT_fpch_preprocess = 842,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 843,                     /* -fpeel-loops */
  OPT_fpeephole = 844,                       /* -fpeephole */
  OPT_fpeephole2 = 845,                      /* -fpeephole2 */
  OPT_fpermissive = 846,                     /* -fpermissive */
  OPT_fpic = 847,                            /* -fpic */
  OPT_fpie = 848,                            /* -fpie */
  OPT_fplan9_extensions = 849,               /* -fplan9-extensions */
  OPT_fplt = 850,                            /* -fplt */
  ...
  OPT_mabi_ = 1137,                          /* -mabi= */
  OPT_march_ = 1138,                         /* -march= */
  OPT_mbig_endian = 1139,                    /* -mbig-endian */
  OPT_mbionic = 1140,                        /* -mbionic */
  OPT_mcmodel_ = 1141,                       /* -mcmodel= */
  OPT_mcpu_ = 1142,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1143,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1144,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1145,             /* -mgeneral-regs-only */
  OPT_mglibc = 1146,                         /* -mglibc */
  OPT_mlittle_endian = 1147,                 /* -mlittle-endian */
  OPT_mmusl = 1148,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1149,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1150,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1151,     /* -mpc-relative-literal-loads */
  OPT_mstrict_align = 1152,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1153,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1154,                     /* -mtls-size= */
  OPT_mtune_ = 1155,                         /* -mtune= */
  OPT_muclibc = 1156,                        /* -muclibc */
  OPT_n = 1157,                              /* -n */
  OPT_no_canonical_prefixes = 1158,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1159,              /* -no-integrated-cpp */
  OPT_nocpp = 1160,                          /* -nocpp */
  OPT_nodefaultlibs = 1161,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1162,                   /* -nostartfiles */
  OPT_nostdinc = 1163,                       /* -nostdinc */
  OPT_nostdinc__ = 1164,                     /* -nostdinc++ */
  OPT_nostdlib = 1165,                       /* -nostdlib */
  OPT_o = 1166,                              /* -o */
  OPT_p = 1167,                              /* -p */
  OPT_pass_exit_codes = 1168,                /* -pass-exit-codes */
  /* OPT_pedantic = 1169, */                 /* -pedantic */
  OPT_pedantic_errors = 1170,                /* -pedantic-errors */
  OPT_pg = 1171,                             /* -pg */
  OPT_pie = 1172,                            /* -pie */
  OPT_pipe = 1173,                           /* -pipe */
  OPT_posix = 1174,                          /* -posix */
  OPT_print_file_name_ = 1175,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1176,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1177,          /* -print-multi-directory */
  OPT_print_multi_lib = 1178,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1179,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1180,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1181,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1182,               /* -print-prog-name= */
  OPT_print_search_dirs = 1183,              /* -print-search-dirs */
  OPT_print_sysroot = 1184,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1185,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1186,                        /* -profile */
  OPT_pthread = 1187,                        /* -pthread */
  OPT_quiet = 1188,                          /* -quiet */
  OPT_r = 1189,                              /* -r */
  OPT_rdynamic = 1190,                       /* -rdynamic */
  OPT_remap = 1191,                          /* -remap */
  OPT_s = 1192,                              /* -s */
  OPT_s_bc_abi = 1193,                       /* -s-bc-abi */
  OPT_save_temps = 1194,                     /* -save-temps */
  OPT_save_temps_ = 1195,                    /* -save-temps= */
  OPT_shared = 1196,                         /* -shared */
  OPT_shared_libgcc = 1197,                  /* -shared-libgcc */
  /* OPT_specs = 1198, */                    /* -specs */
  OPT_specs_ = 1199,                         /* -specs= */
  OPT_static = 1200,                         /* -static */
  OPT_static_libasan = 1201,                 /* -static-libasan */
  OPT_static_libgcc = 1202,                  /* -static-libgcc */
  OPT_static_libgcj = 1203,                  /* -static-libgcj */
  OPT_static_libgfortran = 1204,             /* -static-libgfortran */
  OPT_static_libgo = 1205,                   /* -static-libgo */
  OPT_static_liblsan = 1206,                 /* -static-liblsan */
  OPT_static_libmpx = 1207,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1208,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1209,               /* -static-libstdc++ */
  OPT_static_libtsan = 1210,                 /* -static-libtsan */
  OPT_static_libubsan = 1211,                /* -static-libubsan */
  /* OPT_std_c__03 = 1212, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1213, */                /* -std=c++0x */
  OPT_std_c__11 = 1214,                      /* -std=c++11 */
  OPT_std_c__14 = 1215,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1216, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1217, */                /* -std=c++1y */
  OPT_std_c__1z = 1218,                      /* -std=c++1z */
  OPT_std_c__98 = 1219,                      /* -std=c++98 */
  OPT_std_c11 = 1220,                        /* -std=c11 */
  /* OPT_std_c1x = 1221, */                  /* -std=c1x */
  /* OPT_std_c89 = 1222, */                  /* -std=c89 */
  OPT_std_c90 = 1223,                        /* -std=c90 */
  OPT_std_c99 = 1224,                        /* -std=c99 */
  /* OPT_std_c9x = 1225, */                  /* -std=c9x */
  OPT_std_f2003 = 1226,                      /* -std=f2003 */
  OPT_std_f2008 = 1227,                      /* -std=f2008 */
  OPT_std_f2008ts = 1228,                    /* -std=f2008ts */
  OPT_std_f95 = 1229,                        /* -std=f95 */
  OPT_std_gnu = 1230,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1231, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1232, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1233,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1234,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1235, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1236, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1237,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1238,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1239,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1240, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1241, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1242,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1243,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1244, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1245, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1246,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1247, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1248, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1249, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1250,                     /* -std=legacy */
  OPT_symbolic = 1251,                       /* -symbolic */
  OPT_t = 1252,                              /* -t */
  OPT_time = 1253,                           /* -time */
  OPT_time_ = 1254,                          /* -time= */
  OPT_traditional = 1255,                    /* -traditional */
  OPT_traditional_cpp = 1256,                /* -traditional-cpp */
  OPT_trigraphs = 1257,                      /* -trigraphs */
  OPT_u = 1258,                              /* -u */
  OPT_undef = 1259,                          /* -undef */
  OPT_v = 1260,                              /* -v */
  OPT_version = 1261,                        /* -version */
  OPT_w = 1262,                              /* -w */
  OPT_wrapper = 1263,                        /* -wrapper */
  OPT_x = 1264,                              /* -x */
  OPT_z = 1265,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
